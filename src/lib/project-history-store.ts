...
import { projectSnapshotSchema } from "./project-files";
...
const generationSchema=z.object({id:generationIdSchema,summary:z.string().trim().min(1).max(800),snapshot:projectSnapshotSchema}).strict();
